...
#pragma omp parallel shared(a, b, nthreads, locka, lockb) private(tid)
  ...
  #pragma omp sections nowait
    ...
    #pragma omp section
    /**
     * Two section have different lock require order
     * This may cause section1 hold locka requiring lockb
     * and section2 hold lockb requiring locka, thus deadlock.
     * Change the order to be uniform.
     **/
      {
